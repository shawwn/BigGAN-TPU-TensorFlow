...
#batch=2048
#examples=$(($batch * 250000))
#batch=256
#examples=$(($batch * 1000000))
...
exec python3 main_tpu.py --use-tpu --tpu-name $tpu \
	...
	--model-dir gs://gpt-2-poetry/gan/imagenet96-96-64/model \
	--checkpoint-dir gs://gpt-2-poetry/gan/imagenet96-96-64/checkpoint-$run \
	--result-dir ./results \
	--batch-size $batch  \
	--ch 96 \
	--layers 5 \
